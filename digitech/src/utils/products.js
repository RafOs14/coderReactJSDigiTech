const products = [
    ...
    {id: 27,
        ...
        description: "The Xiaomi Redmi Note 10 Pro is a bang-for-the-buck midrange smartphone. It features a 6.67-inch FHD+ AMOLED display with 120Hz refresh rate, 108MP + 8MP + 5MP + 2MP quad rear camera setup, and a single 16MP selfie camera. It runs on a Qualcomm Snapdragon 732G chipset with either 6GB or 8GB RAM, Android 11 OS, and MIUI 12 software. There's also a side-mounted fingerprint scanner, 4G LTE connectivity, Hi-Res audio, and 128GB of expandable storage.",
        brand: "Xiaomi",
        price: 437,
        stock: 7,    
        quantity: 0,
    ...
    {id: 28,
        ...
        description: "Xiaomi Redmi Note 10s Mobile with detailed specs. Xiaomi Redmi Note 10s is equipped with Helio G95 SoC that has Octa-Core CPU and Mali-G76 MP16 GPU. The display is 6.43 AMOLED panel with the resolution of 1080 x 2400 pixels. Xiaomi Redmi Note 10s is available with 6, 8GB of RAM and 64, 128GB of built-in storage/ROM",
        brand: "Xiaomi",
        price: 299,
        stock: 17,    
        quantity: 0,
    ...
    {id: 30,
        ...
        description: "This Apple iPhone XR has 3 GB ram, 64 GB, 128 GB, 256 GB Internal Memory (ROM) and No External Memory Card. Apple iPhone XR comes with 6.1 inches, 90.3 cm2 (~79.0% screen-to-body ratio), Liquid Retina IPS LCD, 625 nits (typ) display with a resolution of 828 x 1792 pixels, 19.5:9 ratio at a pixel density of 326 ppi density.",
        brand: "Apple",
        price: 569,
        stock: 2,    
        quantity: 0,
